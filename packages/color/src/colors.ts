...
export class Color {
  ...
  get lightShades(): LightShadeScheme {
    return this.createLightShades()
  }

  get darkShades(): DarkShadeScheme {
    return this.createDarkShades()
  }

  get shades(): ShadeScheme {
    return this.createShades()
  }

  get complements(): Scheme<'primary' | 'secondary'> {
    return createComplementaryScheme(this)
  }

  get analogousComplements(): Scheme<'primary' | 'secondary'> {
    return createAnalogousComplementaryScheme(this)
  }

  get splitComplements(): Scheme<'primary' | 'secondary'> {
    return createSplitComplementaryScheme(this)
  }

  get triadicComplements(): Scheme<'tertiary' | 'primary' | 'secondary'> {
    return createTriadicComplementaryScheme(this)
  }

  get squareComplements(): Scheme<'primary' | 'secondary' | 'tertiary' | 'quartenary'> {
    return createSquareComplementaryScheme(this)
  }

  get tetradicComplements(): Scheme<'primary' | 'secondary' | 'tertiary' | 'quartenary'> {
  ...
  complement(value = 180): Color {
    return complement(this, value)
  }

  mix(color: Color, mode: MixMode = MixMode.RGB_SUBTRACTIVE): Color {
  ...
  createLightShades(options?: SchemeOptions): LightShadeScheme {
    return createLightShadeScheme(this, options)
  }

  createDarkShades(options?: SchemeOptions): DarkShadeScheme {
    return createDarkShadeScheme(this, options)
  }

  createShades(options?: SchemeOptions): ShadeScheme {
 ...
 * @returns {boolean}
 */
export const isSpace = (color: Color, space: ColorSpace): boolean => color.space === space

export const isRgb = (color: Color): boolean => isSpace(color, ColorSpace.RGB)

export const isRgba = (color: Color): boolean => isSpace(color, ColorSpace.RGBA)

export const isAnyRgb = (color: Color): boolean => isRgb(color) || isRgba(color)

export const isHsl = (color: Color): boolean => isSpace(color, ColorSpace.HSL)

export const isHsla = (color: Color): boolean => isSpace(color, ColorSpace.HSLA)
...
export const toRgb = (color: Color): Color => toSpace(color, ColorSpace.RGB)

export const toRgba = (color: Color): Color => toSpace(color, ColorSpace.RGBA)

export const toAnyRgb = (color: Color): Color => (isAlpha(color) ? toRgba(color) : toRgb(color))

export const toHsl = (color: Color): Color => toSpace(color, ColorSpace.HSL)

export const toHsla = (color: Color): Color => toSpace(color, ColorSpace.HSLA)

export const toAnyHsl = (color: Color): Color => (isAlpha(color) ? toHsla(color) : toHsl(color))

export const toAnyAlpha = (color: Color): Color => {
  if (isAnyHsl(color)) {
    return toHsla(color)
  }
  return toRgba(color)
...
export const toAnyOpaque = (color: Color): Color => {
  if (isAnyHsl(color)) {
    return toHsl(color)
  }
  return toRgb(color)
...
export const withRed = (color: Color, value: number): Color => {
...
export const withGreen = (color: Color, value: number): Color => {
...
export const withBlue = (color: Color, value: number): Color => {
...
export const withHue = (color: Color, value: number): Color => {
...
export const withSaturation = (color: Color, value: number): Color => {
...
export const withLightness = (color: Color, value: number): Color => {
...
export const withOpacity = (color: Color, value: number): Color => {
...
export const grayscale = (color: Color): Color => withSaturation(color, 0)

export const complement = (color: Color, value = 180): Color => {
  const hue = getHue(color)
  const [hScale] = getSpaceScales(ColorSpace.HSL)
  return withHue(color, rotateValue(hue + value, hScale))
}

export const lighten = (color: Color, value: number): Color =>
  withLightness(color, getLightness(color) + value)

export const darken = (color: Color, value: number): Color =>
  withLightness(color, getLightness(color) - value)

export const tint = (color: Color, value: number): Color =>
  withSaturation(color, getSaturation(color) + value)

export const tone = (color: Color, value: number): Color =>
  withSaturation(color, getSaturation(color) - value)

export const fadeIn = (color: Color, value: number): Color =>
  withOpacity(color, getOpacity(color) + value)

export const fadeOut = (color: Color, value: number): Color =>
  withOpacity(color, getOpacity(color) - value)
